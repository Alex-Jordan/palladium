...
\begin{tikzpicture}
    \begin{axis}[xmin=-5,
        ...
        \addplot+[domain=-3.685:8.685] {x^2-5*x-14} node[pos=0.9, left] {$y=x^2-5x-14$};
        \addplot+[domain=-5:10] {0} node[pos=0.5, above] {$y=0$};
        \addplot[soliddot,color=fifthcolor] coordinates {(-2,0)} node[above left] {$(-2,0)$};
        \addplot[soliddot,color=fifthcolor] coordinates {(7,0)} node[above right] {$(7,0)$};
    \end{axis}
\end{tikzpicture}%
}
\end{document}
