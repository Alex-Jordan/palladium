...
\begin{tikzpicture}
  \begin{axis}[ymin=-50,width=0.47\linewidth,height=0.35\linewidth,
              ymax=100,
              xmin=-1000,
              xmax=20000,
              ytick={},
              ...
              xtick={},
              minor xtick={},
              xlabel={$x$, pairs of shoes},ylabel={$y$, average cost}]
    \addplot[firstcurve,domain=4286:20000] {(30*x+300000)/x};
    \addplot[secondcurve,domain=0:20000] {50};
    \addplot[soliddot, above] coordinates {(15000,50)} node{$(15000,50)$};
  \end{axis}
\end{tikzpicture}%
}
\end{document}
