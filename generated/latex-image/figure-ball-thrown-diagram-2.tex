...
\begin{tikzpicture}
    \begin{axis}[axis x line=none,
                ...
                ymax=150,
                grid=none]
        \addplot[color=firstcolor, fill=firstcolor!30] coordinates{(-1.5,0)(-1.5,80)(0.5,80)(0.5,0)(-1.5,0)};
        ...
        \addplot[mark=*, samples=15, variable=\t, domain=0:5, smooth, -, color=secondcolor] ({t}, {-16*t^2+64*t+80});
    \end{axis}
\end{tikzpicture}%
}
\end{document}
