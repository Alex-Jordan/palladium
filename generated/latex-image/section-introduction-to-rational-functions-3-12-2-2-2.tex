...
\begin{tikzpicture}
  \begin{axis}[ymin=-2000,,width=0.47\linewidth,height=0.35\linewidth,
              ymax=2000,
              xmin=-2000,
              xmax=2000,
              ytick={-1000,1000},
    ...
    \addplot [firstcurve, domain=-2000:-147.783, samples=150] {(30*x+300000)/x};
    \addplot [firstcurve, domain=153:2000, samples=150] {(30*x+300000)/x};
  \end{axis}
\end{tikzpicture}%
}
\end{document}
