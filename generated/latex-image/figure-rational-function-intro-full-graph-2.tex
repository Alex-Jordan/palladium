...
\begin{tikzpicture}
    \begin{axis}[]
        ...
        \addplot [asymptote] coordinates {(-7,0.05) (7,0.05)};
        \addplot [firstcurve, domain=-7:1.857, samples=50, smooth] {1/(x-2)};
        \addplot [firstcurve, domain=2.143:7, samples=50, smooth] {1/(x-2)};
        \addplot [soliddot,color=firstcolor] coordinates {(-6,-0.125) (-4,-0.167) (-2,-0.25) (0,-0.5) (1,-1) (1.5,-2) (1.8,-5) (2.2,5) (2.5,2) (3,1) (4,0.5) (6,0.25)};
    \end{axis}
\end{tikzpicture}%
}
\end{document}
