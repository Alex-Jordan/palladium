...
\begin{tikzpicture}
    \begin{axis}[xmin=-2,
        ...
        \addplot+[domain=-1.325:11.325] {x^2-10*x+25} node[pos=0.9, left] {$y=x^2-10x+25$};
        \addplot+[domain=-4:14] {0} node[pos=0.7, above] {$y=0$};
        \addplot[soliddot,color=fifthcolor] coordinates {(5,0)} node[above] {$(5,0)$};
    \end{axis}
\end{tikzpicture}%
}
\end{document}
