...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=-1:(1698/241)]{((241/3)*(x-6)+516)};
    \addplot[soliddot] coordinates {(6,516)} node[below right] {\((6,516)\)};
    \addplot[soliddot] coordinates {(3,275)} node[below right] {\((3,275)\)};
  \end{axis}
\end{tikzpicture}
