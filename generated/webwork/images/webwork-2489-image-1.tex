...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(F\)} (3,-1)
  -- node[pos=0.5,right]{\(\left({\frac{7}{8}}\right)F\)} (3.5,2)
  -- node[pos=0.5,above]{\(\left({\frac{5}{6}}\right)P\)} (2,2.5)
  -- node[pos=0.5,left]{\(\left({\frac{9}{8}}\right)P\)} cycle;   
\end{tikzpicture}
