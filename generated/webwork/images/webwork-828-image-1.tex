...
\begin{tikzpicture}
  ...
  -- node[pos=0.5,below right]{\(\left({\frac{6}{7}}\right)J\)} (3,1)
  -- node[pos=0.5,above right]{\(\left({\frac{8}{3}}\right)X\)} (0,3)
  -- node[pos=0.5,above left]{\(\left({\frac{2}{5}}\right)l\)} (-1,3)
  -- node[pos=0.5,left]{\(\left({\frac{3}{2}}\right)X\)} (-1,1)
  -- node[pos=0.5,below left]{\(J\)} cycle;   
\end{tikzpicture}
