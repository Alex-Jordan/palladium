...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(8.7g\)} (2,0)
  -- node[pos=0.5,below right]{\(27P\)} (4,1)
  -- node[pos=0.5,above right]{\(29g\)} (2,3)
  -- node[pos=0.5,above left]{\(70P\)} (-1,2)
  -- node[pos=0.5,left]{\(P\)} (-1,1)
  -- node[pos=0.5,below left]{\(7.8g\)} cycle;   
\end{tikzpicture}
