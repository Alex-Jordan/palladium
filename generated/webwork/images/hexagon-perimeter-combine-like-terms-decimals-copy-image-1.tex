...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(L\)} (1,0)
  -- node[pos=0.5,below right]{\(42L\)} (3,1)
  -- node[pos=0.5,above right]{\(45v\)} (2,3)
  -- node[pos=0.5,above left]{\(62v\)} (-1,3)
  -- node[pos=0.5,left]{\(9.6L\)} (-1,1)
  -- node[pos=0.5,below left]{\(9.2v\)} cycle;   
\end{tikzpicture}
