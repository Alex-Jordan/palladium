...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(-0.0769231*(x-14)+41)};
    \addplot[soliddot] coordinates {(14,41)} node[above right] {\((14,41)\)};
    \addplot[soliddot] coordinates {(53,38)} node[below left] {\((53,38)\)};
  \end{axis}
\end{tikzpicture}
