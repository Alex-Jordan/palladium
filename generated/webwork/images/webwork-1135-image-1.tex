...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(-0.5625*(x-57.9)+17.3)};
    \addplot[soliddot] coordinates {(57.9,17.3)} node[below left] {\((57.9,17.3)\)};
    \addplot[soliddot] coordinates {(46.7,23.6)} node[above right] {\((46.7,23.6)\)};
  \end{axis}
\end{tikzpicture}
