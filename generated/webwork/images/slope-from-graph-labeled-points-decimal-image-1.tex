...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(-0.274648*(x-17.6)+18.2)};
    \addplot[soliddot] coordinates {(17.6,18.2)} node[above right] {\((17.6,18.2)\)};
    \addplot[soliddot] coordinates {(31.8,14.3)} node[below left] {\((31.8,14.3)\)};
  \end{axis}
\end{tikzpicture}
