...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\({\frac{4}{5}}R\)} (2,0)
  -- node[pos=0.5,below right]{\({\frac{2}{3}}R\)} (3,1)
  -- node[pos=0.5,above right]{\({\frac{9}{5}}M\)} (0,3)
  -- node[pos=0.5,above left]{\({\frac{1}{3}}M\)} (-1,3)
  -- node[pos=0.5,left]{\({\frac{10}{9}}d\)} (-1,1)
  -- node[pos=0.5,below left]{\({\frac{5}{7}}d\)} cycle;   
\end{tikzpicture}
