...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\({\frac{2}{3}}P\)} (1,0)
  -- node[pos=0.5,below right]{\(U\)} (3,1)
  -- node[pos=0.5,above right]{\({\frac{7}{5}}P\)} (2,3)
  -- node[pos=0.5,above left]{\(2U\)} (-1,3)
  -- node[pos=0.5,left]{\({\frac{4}{5}}w\)} (-1,1)
  -- node[pos=0.5,below left]{\({\frac{7}{9}}w\)} cycle;   
\end{tikzpicture}
