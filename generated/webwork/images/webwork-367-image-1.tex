...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(2.33333*(x-55)+64)};
    \addplot[soliddot] coordinates {(55,64)} node[above left] {\((55,64)\)};
    \addplot[soliddot] coordinates {(46,43)} node[below right] {\((46,43)\)};
  \end{axis}
\end{tikzpicture}
