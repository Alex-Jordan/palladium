...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(\left({\frac{1}{7}}\right)f\)} (1,0)
  -- node[pos=0.5,below right]{\(b\)} (3,1)
  -- node[pos=0.5,above right]{\(\left({\frac{9}{7}}\right)u\)} (2,3)
  -- node[pos=0.5,above left]{\(5f\)} (-1,3)
  -- node[pos=0.5,left]{\(\left({\frac{3}{4}}\right)b\)} (-1,1)
  -- node[pos=0.5,below left]{\(\left({\frac{2}{5}}\right)u\)} cycle;   
\end{tikzpicture}
