...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(-0.52967*(x-30.3)+50.7)};
    \addplot[soliddot] coordinates {(30.3,50.7)} node[above right] {\((30.3,50.7)\)};
    \addplot[soliddot] coordinates {(75.8,26.6)} node[below left] {\((75.8,26.6)\)};
  \end{axis}
\end{tikzpicture}
