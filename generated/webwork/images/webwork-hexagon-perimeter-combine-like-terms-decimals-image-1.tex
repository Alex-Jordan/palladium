...
\begin{tikzpicture}
  ...
  -- node[pos=0.5,below right]{\(6.5X\)} (4,1)
  -- node[pos=0.5,above right]{\(6.9L\)} (2,3)
  -- node[pos=0.5,above left]{\(9.4X\)} (-1,2)
  -- node[pos=0.5,left]{\(0.1L\)} (-1,1)
  -- node[pos=0.5,below left]{\(L\)} cycle;   
\end{tikzpicture}
