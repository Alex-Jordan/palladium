...
\begin{tikzpicture}
  \draw[fill=wood] (0,-1)
  -- node[pos=0.5,below]{\(4.4v\)} (2,0)
  -- node[pos=0.5,below right]{\(v\)} (3,1)
  -- node[pos=0.5,above right]{\(v\)} (2,2)
  -- node[pos=0.5,above left]{\(3.5K\)} (0,2)
  -- node[pos=0.5,left]{\(K\)} (-1,1)
  -- node[pos=0.5,below left]{\(11K\)} cycle;   
\end{tikzpicture}
