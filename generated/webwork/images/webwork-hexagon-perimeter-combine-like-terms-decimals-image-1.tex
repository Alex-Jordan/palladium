...
\begin{tikzpicture}
  \draw[fill=wood] (0,-1)
  -- node[pos=0.5,below]{\(9.7z\)} (2,0)
  -- node[pos=0.5,below right]{\(I\)} (3,1)
  -- node[pos=0.5,above right]{\(I\)} (2,2)
  -- node[pos=0.5,above left]{\(z\)} (0,2)
  -- node[pos=0.5,left]{\(z\)} (-1,1)
  -- node[pos=0.5,below left]{\(23I\)} cycle;   
\end{tikzpicture}
