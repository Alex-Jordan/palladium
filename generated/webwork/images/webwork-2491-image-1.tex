...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(e\)} (1,0)
  -- node[pos=0.5,below right]{\(8.7e\)} (3,1)
  -- node[pos=0.5,above right]{\(9.9Q\)} (2,3)
  -- node[pos=0.5,above left]{\(90Q\)} (-1,3)
  -- node[pos=0.5,left]{\(4.7Q\)} (-1,1)
  -- node[pos=0.5,below left]{\(e\)} cycle;   
\end{tikzpicture}
