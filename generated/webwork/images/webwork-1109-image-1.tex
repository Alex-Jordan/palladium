...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[soliddot] coordinates {(3,-2)} node[pin=60:{A}] {};
    \addplot[soliddot] coordinates {(-1,0)} node[pin=60:{B}] {};
    \addplot[soliddot] coordinates {(0,1)} node[pin=60:{C}] {};
    \addplot[soliddot] coordinates {(4,2)} node[pin=60:{D}] {};
  \end{axis}
\end{tikzpicture}
