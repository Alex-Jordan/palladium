...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=(240/151):(1540/151)]{(116-(151/2)*(x-8))};
    \addplot[soliddot] coordinates {(8,116)} node[below left] {\((8,116)\)};
    \addplot[soliddot] coordinates {(4,418)} node[below left] {\((4,418)\)};
  \end{axis}
\end{tikzpicture}
