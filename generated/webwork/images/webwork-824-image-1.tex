...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(\left({\frac{10}{7}}\right)l\)} (3,0)
  -- node[pos=0.5,right]{\(\left({\frac{2}{3}}\right)H\)} (3.5,2)
  -- node[pos=0.5,above]{\(\left({\frac{1}{4}}\right)H\)} (2,2.5)
  -- node[pos=0.5,left]{\(2l\)} cycle;   
\end{tikzpicture}
