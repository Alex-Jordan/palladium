...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=9.23838383838384:37.0161616161616,samples=2] {(3.96*(x-15.4)+14.4)};
    \addplot[soliddot] coordinates {(15.4,14.4)} node[below right] {\((15.4,14.4)\)};
    \addplot[soliddot] coordinates {(20.4,34.2)} node[above left] {\((20.4,34.2)\)};
  \end{axis}
\end{tikzpicture}
