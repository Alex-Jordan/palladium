...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(-0.7*(x-14)+37)};
    \addplot[soliddot] coordinates {(14,37)} node[above right] {\((14,37)\)};
    \addplot[soliddot] coordinates {(34,23)} node[below left] {\((34,23)\)};
  \end{axis}
\end{tikzpicture}
