...
\begin{document}
\begin{tikzpicture}
\begin{axis}[xmin=-5,xmax=60,ymin=-5,ymax=70,xtick={-100,-95,...,100},ytick={-100,-95,...,100},minor xtick={-100,-99,...,100},minor ytick={-100,-99,...,100}]
\addplot[firstcurve,-,domain=-5:60]{((110.25-2.25*x)/1.75)};
\addplot[secondcurve,-,domain=-5:60]{(57-x)};
\end{axis}
\end{tikzpicture}
