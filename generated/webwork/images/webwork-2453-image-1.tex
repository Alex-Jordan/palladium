...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(\left({\frac{3}{2}}\right)p\)} (3,0)
  -- node[pos=0.5,right]{\(\left({\frac{4}{7}}\right)F\)} (3.5,2)
  -- node[pos=0.5,above]{\(\left({\frac{1}{2}}\right)p\)} (2,2.5)
  -- node[pos=0.5,left]{\(2F\)} cycle;   
\end{tikzpicture}
