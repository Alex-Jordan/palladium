...
\begin{document}
\begin{tikzpicture}
\begin{axis}[xmin=-5,xmax=50,ymin=-40,ymax=20,xtick={-100,-95,...,100},ytick={-100,-95,...,100},minor xtick={-100,-99,...,100},minor ytick={-100,-99,...,100}]
\addplot[firstcurve,-,domain=-5:50]{((48-x)/4)};
\addplot[secondcurve,-,domain=-5:50]{(x-38)};
\end{axis}
\end{tikzpicture}
