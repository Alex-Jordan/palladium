...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:70.0929824561404,samples=2] {(-1.30038*(x-19.8)+55.4)};
    \addplot[soliddot] coordinates {(19.8,55.4)} node[above right] {\((19.8,55.4)\)};
    \addplot[soliddot] coordinates {(46.1,21.2)} node[below left] {\((46.1,21.2)\)};
  \end{axis}
\end{tikzpicture}
