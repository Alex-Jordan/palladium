...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=(61/58):11]{(324-(232/5)*(x-7))};
    \addplot[soliddot] coordinates {(7,324)} node[below left] {\((7,324)\)};
    \addplot[soliddot] coordinates {(2,556)} node[below left] {\((2,556)\)};
  \end{axis}
\end{tikzpicture}
