...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(\left({\frac{3}{2}}\right)Z\)} (3,-1)
  -- node[pos=0.5,right]{\(\left({\frac{4}{5}}\right)t\)} (3.5,2)
  -- node[pos=0.5,above]{\(\left({\frac{3}{5}}\right)t\)} (2,2.5)
  -- node[pos=0.5,left]{\(\left({\frac{8}{3}}\right)Z\)} cycle;   
\end{tikzpicture}
