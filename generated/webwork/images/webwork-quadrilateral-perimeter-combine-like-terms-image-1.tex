...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(\left({\frac{5}{4}}\right)z\)} (3,-1)
  -- node[pos=0.5,right]{\(\left({\frac{5}{7}}\right)z\)} (3.5,1)
  -- node[pos=0.5,above]{\(\left({\frac{1}{6}}\right)I\)} (2,2.5)
  -- node[pos=0.5,left]{\(I\)} cycle;   
\end{tikzpicture}
