...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(\left({\frac{10}{7}}\right)s\)} (3,0)
  -- node[pos=0.5,right]{\(\left({\frac{5}{4}}\right)s\)} (3.5,2)
  -- node[pos=0.5,above]{\(\left({\frac{2}{9}}\right)n\)} (2,2.5)
  -- node[pos=0.5,left]{\(4n\)} cycle;   
\end{tikzpicture}
