...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(\left({\frac{9}{4}}\right)g\)} (3,0)
  -- node[pos=0.5,right]{\(\left({\frac{9}{7}}\right)g\)} (3.5,2)
  -- node[pos=0.5,above]{\(\left({\frac{1}{4}}\right)y\)} (2,2.5)
  -- node[pos=0.5,left]{\(3y\)} cycle;   
\end{tikzpicture}
