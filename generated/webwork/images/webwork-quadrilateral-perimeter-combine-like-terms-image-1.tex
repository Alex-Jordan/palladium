...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(\left({\frac{9}{5}}\right)k\)} (4,0)
  -- node[pos=0.5,right]{\(\left({\frac{1}{3}}\right)k\)} (3.5,2)
  -- node[pos=0.5,above]{\(L\)} (1,2.5)
  -- node[pos=0.5,left]{\(\left({\frac{3}{2}}\right)L\)} cycle;   
\end{tikzpicture}
