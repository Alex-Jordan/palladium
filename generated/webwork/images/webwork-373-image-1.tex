...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=20.2627906976744:73.9837209302326,samples=2] {(2.04762*(x-31.3)+12.6)};
    \addplot[soliddot] coordinates {(31.3,12.6)} node[below right] {\((31.3,12.6)\)};
    \addplot[soliddot] coordinates {(41.8,34.1)} node[above left] {\((41.8,34.1)\)};
  \end{axis}
\end{tikzpicture}
