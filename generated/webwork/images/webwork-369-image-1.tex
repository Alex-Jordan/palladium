...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(-8*(x-70)+52)};
    \addplot[soliddot] coordinates {(70,52)} node[below left] {\((70,52)\)};
    \addplot[soliddot] coordinates {(67,76)} node[above right] {\((67,76)\)};
  \end{axis}
\end{tikzpicture}
