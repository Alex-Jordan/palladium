...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=58.815625:74.284375,samples=2] {(-7.11111*(x-70.6)+16.2)};
    \addplot[soliddot] coordinates {(70.6,16.2)} node[below left] {\((70.6,16.2)\)};
    \addplot[soliddot] coordinates {(67.9,35.4)} node[above right] {\((67.9,35.4)\)};
  \end{axis}
\end{tikzpicture}
