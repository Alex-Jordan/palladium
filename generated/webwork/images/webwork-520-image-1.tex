...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=(117/232):(2067/232)]{((232/3)*(x-6)+375)};
    \addplot[soliddot] coordinates {(6,375)} node[below right] {\((6,375)\)};
    \addplot[soliddot] coordinates {(3,143)} node[below right] {\((3,143)\)};
  \end{axis}
\end{tikzpicture}
