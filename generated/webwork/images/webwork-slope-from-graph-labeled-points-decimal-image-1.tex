...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=6.49964349376114:87.4800356506239,samples=2] {(1.35835*(x-23.8)+13.5)};
    \addplot[soliddot] coordinates {(23.8,13.5)} node[below right] {\((23.8,13.5)\)};
    \addplot[soliddot] coordinates {(65.1,69.6)} node[above left] {\((65.1,69.6)\)};
  \end{axis}
\end{tikzpicture}
