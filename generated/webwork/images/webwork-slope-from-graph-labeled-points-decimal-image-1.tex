...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-0.0178770949720573:83.9672253258845,samples=2] {(-1.30976*(x-63.2)+17.2)};
    \addplot[soliddot] coordinates {(63.2,17.2)} node[below left] {\((63.2,17.2)\)};
    \addplot[soliddot] coordinates {(22.2,70.9)} node[above right] {\((22.2,70.9)\)};
  \end{axis}
\end{tikzpicture}
