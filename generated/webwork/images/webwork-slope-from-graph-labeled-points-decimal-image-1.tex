...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:51.9622641509434,samples=2] {(1.65625*(x-22.8)+51.7)};
    \addplot[soliddot] coordinates {(22.8,51.7)} node[below right] {\((22.8,51.7)\)};
    \addplot[soliddot] coordinates {(29.2,62.3)} node[above left] {\((29.2,62.3)\)};
  \end{axis}
\end{tikzpicture}
