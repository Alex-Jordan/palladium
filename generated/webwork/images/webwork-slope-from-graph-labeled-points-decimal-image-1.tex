...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=25.4486486486486:93.827027027027,samples=2] {(-1.6087*(x-78.1)+15.3)};
    \addplot[soliddot] coordinates {(78.1,15.3)} node[below left] {\((78.1,15.3)\)};
    \addplot[soliddot] coordinates {(43.6,70.8)} node[above right] {\((43.6,70.8)\)};
  \end{axis}
\end{tikzpicture}
