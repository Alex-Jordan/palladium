...
\begin{tikzpicture}
  \draw[fill=wood] (0,-1)
  -- node[pos=0.5,below]{\(X\)} (2,0)
  -- node[pos=0.5,below right]{\(\left({\frac{1}{3}}\right)X\)} (3,1)
  -- node[pos=0.5,above right]{\(\left({\frac{2}{5}}\right)I\)} (2,2)
  -- node[pos=0.5,above left]{\(\left({\frac{1}{2}}\right)I\)} (0,2)
  -- node[pos=0.5,left]{\(\left({\frac{4}{9}}\right)m\)} (-1,1)
  -- node[pos=0.5,below left]{\(\left({\frac{7}{3}}\right)m\)} cycle;   
\end{tikzpicture}
