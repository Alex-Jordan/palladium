...
\begin{tikzpicture}
  \draw[fill=wood] (0,-1)
  -- node[pos=0.5,below]{\(\left({\frac{7}{4}}\right)R\)} (2,0)
  -- node[pos=0.5,below right]{\(\left({\frac{4}{7}}\right)i\)} (3,1)
  -- node[pos=0.5,above right]{\(\left({\frac{7}{9}}\right)R\)} (2,2)
  -- node[pos=0.5,above left]{\(\left({\frac{5}{3}}\right)i\)} (0,2)
  -- node[pos=0.5,left]{\(\left({\frac{5}{4}}\right)Z\)} (-1,1)
  -- node[pos=0.5,below left]{\(\left({\frac{9}{5}}\right)Z\)} cycle;   
\end{tikzpicture}
