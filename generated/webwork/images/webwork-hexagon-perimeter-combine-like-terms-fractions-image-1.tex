...
\begin{tikzpicture}
  \draw[fill=wood] (0,-1)
  -- node[pos=0.5,below]{\(3L\)} (2,0)
  -- node[pos=0.5,below right]{\(\left({\frac{1}{10}}\right)X\)} (3,1)
  -- node[pos=0.5,above right]{\(\left({\frac{9}{10}}\right)R\)} (2,2)
  -- node[pos=0.5,above left]{\(\left({\frac{5}{2}}\right)R\)} (0,2)
  -- node[pos=0.5,left]{\(\left({\frac{10}{7}}\right)X\)} (-1,1)
  -- node[pos=0.5,below left]{\(5L\)} cycle;   
\end{tikzpicture}
