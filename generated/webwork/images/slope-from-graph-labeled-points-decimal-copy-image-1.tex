...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(0.649805*(x-25.1)+17.3)};
    \addplot[soliddot] coordinates {(25.1,17.3)} node[below right] {\((25.1,17.3)\)};
    \addplot[soliddot] coordinates {(76.5,50.7)} node[above left] {\((76.5,50.7)\)};
  \end{axis}
\end{tikzpicture}
