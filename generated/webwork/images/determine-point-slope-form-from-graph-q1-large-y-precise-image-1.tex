...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=(27/82):11]{(363-(82/3)*(x-9))};
    \addplot[soliddot] coordinates {(9,363)} node[below left] {\((9,363)\)};
    \addplot[soliddot] coordinates {(6,445)} node[below left] {\((6,445)\)};
  \end{axis}
\end{tikzpicture}
