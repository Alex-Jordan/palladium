...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(-1.48148*(x-50)+74)};
    \addplot[soliddot] coordinates {(50,74)} node[above right] {\((50,74)\)};
    \addplot[soliddot] coordinates {(77,34)} node[below left] {\((77,34)\)};
  \end{axis}
\end{tikzpicture}
