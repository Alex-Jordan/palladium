...
\begin{tikzpicture}
  \draw[fill=wood] (0,-1)
  -- node[pos=0.5,below]{\(y\)} (2,0)
  -- node[pos=0.5,below right]{\(\left({\frac{1}{2}}\right)y\)} (3,1)
  -- node[pos=0.5,above right]{\(\left({\frac{2}{3}}\right)n\)} (2,2)
  -- node[pos=0.5,above left]{\(\left({\frac{5}{6}}\right)n\)} (0,2)
  -- node[pos=0.5,left]{\(\left({\frac{4}{5}}\right)v\)} (-1,1)
  -- node[pos=0.5,below left]{\(\left({\frac{3}{2}}\right)v\)} cycle;   
\end{tikzpicture}
