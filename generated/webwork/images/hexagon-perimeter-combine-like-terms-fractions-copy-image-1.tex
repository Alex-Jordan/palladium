...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\({\frac{7}{8}}L\)} (1,0)
  -- node[pos=0.5,below right]{\({\frac{8}{7}}X\)} (3,1)
  -- node[pos=0.5,above right]{\({\frac{5}{3}}i\)} (2,3)
  -- node[pos=0.5,above left]{\(2i\)} (-1,3)
  -- node[pos=0.5,left]{\({\frac{9}{8}}L\)} (-1,1)
  -- node[pos=0.5,below left]{\({\frac{10}{9}}X\)} cycle;   
\end{tikzpicture}
