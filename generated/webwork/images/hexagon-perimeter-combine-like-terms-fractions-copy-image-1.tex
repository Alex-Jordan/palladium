...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\({\frac{1}{2}}Z\)} (1,0)
  -- node[pos=0.5,below right]{\({\frac{5}{6}}w\)} (3,1)
  -- node[pos=0.5,above right]{\(T\)} (2,3)
  -- node[pos=0.5,above left]{\(Z\)} (-1,3)
  -- node[pos=0.5,left]{\({\frac{4}{5}}w\)} (-1,1)
  -- node[pos=0.5,below left]{\({\frac{3}{5}}T\)} cycle;   
\end{tikzpicture}
