...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=-1:(1181/109)]{(162-(109/3)*(x-5))};
    \addplot[soliddot] coordinates {(5,162)} node[below left] {\((5,162)\)};
    \addplot[soliddot] coordinates {(2,271)} node[below left] {\((2,271)\)};
  \end{axis}
\end{tikzpicture}
