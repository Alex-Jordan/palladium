...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(6.5y\)} (2,0)
  -- node[pos=0.5,below right]{\(y\)} (3,1)
  -- node[pos=0.5,above right]{\(71I\)} (0,3)
  -- node[pos=0.5,above left]{\(y\)} (-1,3)
  -- node[pos=0.5,left]{\(34I\)} (-1,1)
  -- node[pos=0.5,below left]{\(I\)} cycle;   
\end{tikzpicture}
