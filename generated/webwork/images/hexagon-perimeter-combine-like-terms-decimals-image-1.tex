...
\begin{tikzpicture}
  \draw[fill=wood] (0,-1)
  -- node[pos=0.5,below]{\(49P\)} (2,0)
  -- node[pos=0.5,below right]{\(P\)} (3,1)
  -- node[pos=0.5,above right]{\(5.4F\)} (2,2)
  -- node[pos=0.5,above left]{\(48F\)} (0,2)
  -- node[pos=0.5,left]{\(5.6P\)} (-1,1)
  -- node[pos=0.5,below left]{\(52F\)} cycle;   
\end{tikzpicture}
