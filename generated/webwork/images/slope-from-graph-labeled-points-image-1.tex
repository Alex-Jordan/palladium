...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(-5.33333*(x-73)+68)};
    \addplot[soliddot] coordinates {(73,68)} node[above right] {\((73,68)\)};
    \addplot[soliddot] coordinates {(79,36)} node[below left] {\((79,36)\)};
  \end{axis}
\end{tikzpicture}
