...
\begin{tikzpicture}
  \draw[fill=wood] (0,-1)
  -- node[pos=0.5,below]{\(l\)} (2,0)
  -- node[pos=0.5,below right]{\(\left({\frac{1}{9}}\right)l\)} (3,1)
  -- node[pos=0.5,above right]{\(\left({\frac{2}{5}}\right)D\)} (2,2)
  -- node[pos=0.5,above left]{\(\left({\frac{7}{10}}\right)R\)} (0,2)
  -- node[pos=0.5,left]{\(\left({\frac{2}{5}}\right)D\)} (-1,1)
  -- node[pos=0.5,below left]{\(\left({\frac{7}{4}}\right)R\)} cycle;   
\end{tikzpicture}
