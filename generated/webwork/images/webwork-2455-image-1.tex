...
\begin{tikzpicture}
  \draw[fill=wood] (0,-1)
  -- node[pos=0.5,below]{\(8.1D\)} (2,0)
  -- node[pos=0.5,below right]{\(D\)} (3,1)
  -- node[pos=0.5,above right]{\(D\)} (2,2)
  -- node[pos=0.5,above left]{\(7R\)} (0,2)
  -- node[pos=0.5,left]{\(R\)} (-1,1)
  -- node[pos=0.5,below left]{\(8.7R\)} cycle;   
\end{tikzpicture}
