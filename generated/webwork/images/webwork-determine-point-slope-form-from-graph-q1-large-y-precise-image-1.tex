...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=-1:(257/25)]{(170-(125/3)*(x-5))};
    \addplot[soliddot] coordinates {(5,170)} node[below left] {\((5,170)\)};
    \addplot[soliddot] coordinates {(2,295)} node[below left] {\((2,295)\)};
  \end{axis}
\end{tikzpicture}
