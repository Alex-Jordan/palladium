...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=-1:11]{(348-11*(x-2))};
    \addplot[soliddot] coordinates {(2,348)} node[below left] {\((2,348)\)};
    \addplot[soliddot] coordinates {(6,304)} node[below left] {\((6,304)\)};
  \end{axis}
\end{tikzpicture}
