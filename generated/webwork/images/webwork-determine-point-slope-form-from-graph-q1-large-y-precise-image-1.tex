...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=-1:11]{((72/7)*(x-2)+282)};
    \addplot[soliddot] coordinates {(2,282)} node[below right] {\((2,282)\)};
    \addplot[soliddot] coordinates {(9,354)} node[below right] {\((9,354)\)};
  \end{axis}
\end{tikzpicture}
