...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=-1:11]{(371-16*(x-2))};
    \addplot[soliddot] coordinates {(2,371)} node[below left] {\((2,371)\)};
    \addplot[soliddot] coordinates {(9,259)} node[below left] {\((9,259)\)};
  \end{axis}
\end{tikzpicture}
