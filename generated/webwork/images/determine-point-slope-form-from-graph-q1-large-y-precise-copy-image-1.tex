...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=(61/89):(711/89)]{(572-89*(x-1))};
    \addplot[soliddot] coordinates {(1,572)} node[below left] {\((1,572)\)};
    \addplot[soliddot] coordinates {(4,305)} node[below left] {\((4,305)\)};
  \end{axis}
\end{tikzpicture}
