...
\begin{tikzpicture}
  ...
  -- node[pos=0.5,below right]{\(\left({\frac{1}{4}}\right)e\)} (3,1)
  -- node[pos=0.5,above right]{\(\left({\frac{2}{7}}\right)e\)} (2,2)
  -- node[pos=0.5,above left]{\(\left({\frac{5}{8}}\right)V\)} (0,2)
  -- node[pos=0.5,left]{\(\left({\frac{3}{10}}\right)V\)} (-1,1)
