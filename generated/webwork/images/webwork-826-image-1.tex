...
\begin{tikzpicture}
  \draw[fill=wood] (0,-1)
  -- node[pos=0.5,below]{\(86X\)} (2,0)
  -- node[pos=0.5,below right]{\(4.9x\)} (3,1)
  -- node[pos=0.5,above right]{\(8x\)} (2,2)
  -- node[pos=0.5,above left]{\(14x\)} (0,2)
  -- node[pos=0.5,left]{\(8.9X\)} (-1,1)
  -- node[pos=0.5,below left]{\(91X\)} cycle;   
\end{tikzpicture}
