...
\begin{tikzpicture}
  \draw[fill=wood] (0,0)
  -- node[pos=0.5,below]{\(\left({\frac{8}{3}}\right)T\)} (3,-1)
  -- node[pos=0.5,right]{\(\left({\frac{7}{6}}\right)R\)} (3.5,2)
  -- node[pos=0.5,above]{\(\left({\frac{3}{4}}\right)T\)} (1,2)
  -- node[pos=0.5,left]{\(\left({\frac{1}{3}}\right)R\)} cycle;   
\end{tikzpicture}
