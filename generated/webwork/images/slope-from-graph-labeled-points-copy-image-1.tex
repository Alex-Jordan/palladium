...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(0.423077*(x-80)+27)};
    \addplot[soliddot] coordinates {(80,27)} node[above left] {\((80,27)\)};
    \addplot[soliddot] coordinates {(54,16)} node[below right] {\((54,16)\)};
  \end{axis}
\end{tikzpicture}
