...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(-0.0731707*(x-63)+22)};
    \addplot[soliddot] coordinates {(63,22)} node[below left] {\((63,22)\)};
    \addplot[soliddot] coordinates {(22,25)} node[above right] {\((22,25)\)};
  \end{axis}
\end{tikzpicture}
