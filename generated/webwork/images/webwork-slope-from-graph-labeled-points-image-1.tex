...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(1.25*(x-47)+34)};
    \addplot[soliddot] coordinates {(47,34)} node[below right] {\((47,34)\)};
    \addplot[soliddot] coordinates {(71,64)} node[above left] {\((71,64)\)};
  \end{axis}
\end{tikzpicture}
