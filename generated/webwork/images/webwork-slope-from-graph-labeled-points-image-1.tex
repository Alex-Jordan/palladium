...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(-1.28571*(x-78)+11)};
    \addplot[soliddot] coordinates {(78,11)} node[below left] {\((78,11)\)};
    \addplot[soliddot] coordinates {(43,56)} node[above right] {\((43,56)\)};
  \end{axis}
\end{tikzpicture}
