...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=-10:100,samples=2] {(47*(x-77)+11)};
    \addplot[soliddot] coordinates {(77,11)} node[below right] {\((77,11)\)};
    \addplot[soliddot] coordinates {(78,58)} node[above left] {\((78,58)\)};
  \end{axis}
\end{tikzpicture}
