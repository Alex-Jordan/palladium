...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot+[-,domain=76.1051546391753:81.7752577319588,samples=2] {(19.4*(x-79.1)+48.1)};
    \addplot[soliddot] coordinates {(79.1,48.1)} node[below right] {\((79.1,48.1)\)};
    \addplot[soliddot] coordinates {(80.6,77.2)} node[above left] {\((80.6,77.2)\)};
  \end{axis}
\end{tikzpicture}
