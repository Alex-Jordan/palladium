...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurve, domain=-1:11]{((38/3)*(x-4)+458)};
    \addplot[soliddot] coordinates {(4,458)} node[below right] {\((4,458)\)};
    \addplot[soliddot] coordinates {(1,420)} node[below right] {\((1,420)\)};
  \end{axis}
\end{tikzpicture}
